...
<body>
    ...
    <div class="container commonWidth">
        <div class="location">
            <span>当前 &gt</span>
            <span><?php echo ($user); ?>的书库</span>
        </div>
        <div class="selector">
            <div class="sort book-type">
                <div class="wrap">
                    <div class="book-key">
                        <strong>分 类</strong>
                        <span></span>
                    </div>
                    <div class="book-value d-type">
                        <ul>
        ...
        <div class="book-item commonWidth">
            ...
            <div class="book-i-list">
                <ul>
                <?php if(is_array($ower)): $i = 0; $__LIST__ = $ower;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ower): $mod = ($i % 2 );++$i;?><li class="list-item1 item">
                        <div class="book-img">
                            <a href="<?php echo U('Bookdetail/bookdetail',array('id'=>$ower['book_id'],'name'=>$user));?>" class="img" target="_blank">
                                <img src="/ShareBooks/Public/Uploads/bookImg/<?php echo ($ower['img_url']); ?>" alt="book-img1">
                            </a>
                        </div>
                        <div class="detail">
                            <p class="title">
                                <span class="s-title"><a href="#"><?php echo ($ower['title']); ?></a></span>
                            </p>
                            <p class="tab">
                                <span class="s-tab">标签：<i><?php echo ($ower['catname']); ?></i></span>
                            </p>
                            <p class="author">
                                <span class="s-author">
                                      作者：<a href="#"><?php echo ($ower['author']); ?></a>
                                </span>
                            </p>
                        </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
